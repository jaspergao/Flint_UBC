...
​
​
def getBBMAPCommand(bbmap_index_path, bbmap_index_name, bbmap_number_threads):
...
​
bbmapCMD = getBBMAPCommand(bbmap_index_path=bbmap_index_path,
...
align_subprocess = Popen(bbmapCMD, stdin=PIPE, stdout=PIPE, stderr=PIPE)
​
alignment_output, alignment_error = align_subprocess.communicate(input="\n".join(sample_reads_list)) #
