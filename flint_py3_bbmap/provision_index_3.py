...
# -------------------------------------------------------- Main -------------------------------------------------------
#
# TODO: Complete the correct index copying for BBmap for Provision Index
def main(args):
    """
    ...
    # "spark.executor.memoryOverhead, 1G" originally
    ...
    if args.verbose:
        ...
        # this print line does not work in python 3.6.x
...
def copy_index_to_worker(iterator):
    ...
    Returns:
    Need to refactor this to work in python 3
    """
    return_data = []
