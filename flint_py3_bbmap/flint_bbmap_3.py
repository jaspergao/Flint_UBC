...
def main(args):
    ...
    print("Flint.py Configuration line 164 calling sparkjobs.py")
    sj.set_bowtie2_path(bowtie2_path)
    print(bowtie2_path)
    print("Sucessful bowtie2_path in sparkjobs.py")
    sj.set_bowtie2_index_path(bowtie2_index_path)
    print(bowtie2_index_path)
    print ("Sucessful bowtie2_index_path in sparkjobs.py")
    sj.set_bowtie2_index_name(bowtie2_index_name)
    print(bowtie2_index_name)
    print("Sucessful bowtie2_index_name")
    ...
    for aSample in arrayOfSamples:
        ...
        if use_streaming_dir:
            try:
                ...
                print("stream_source_dir path:....")
                print(stream_source_dir)
        ...
        if use_streaming_dir:
            print("Trying to Stream from Directory....")
            try:
